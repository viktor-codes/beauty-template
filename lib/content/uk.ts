...
export const ukLandingContent = {
  ...
  about: {
    ...
    description:
      "Ласкаво прошу до The Skinbar by Inna Chernovol — тут ваші цілі на першому місці.\n\nПонад 15 років досвіду в естетичній медицині: процедури, після яких ви відчуваєте себе оновленою та впевненою. Від делікатної корекції губ до просунутих лазерних протоколів — індивідуальний підхід, якісні препарати, безпека, комфорт і помітний результат.\n\nРазом складемо персональний план для вашої унікальної beauty-подорожі.",
    stats: [
  ...
  services: {
    ...
    description:
      "Від естетичного догляду за обличчям до просунутих клінічних протоколів — пояснюю простою мовою, тільки обґрунтовані призначення та персональний підхід, без надлишкових процедур.",
    categories: [
      {
  ...
  gallery: {
    ...
    title: "Зазирніть до The Skinbar",
  ...
  reviews: {
    ...
    items: [
      {
        quote:
          "Я просто сяю! Інно, мусила з вами поділитися. За кілька днів після біоревіталізації шкіра буквально сяє зсередини. Подруги постійно кажуть, наскільки вирівнялася текстура і як підтягнулося обличчя. Відчуваю себе свіжою та впевненою. Не можу дочекатися наступного сеансу цієї осені!",
