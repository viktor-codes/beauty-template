...
export { fetchLegalPage } from "@/lib/sanity/fetch/fetch-legal-page";
...
export { mapLegalPageSafe } from "@/lib/sanity/mappers/legal-page";
...
export { legalPageQuery } from "@/lib/sanity/queries/legal-page";
